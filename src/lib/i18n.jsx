  ...
  en: {
    ...
    faq: {
      ...
      items: [
        ...
        { question: "What happens after I book?", answer: "Once you select your time, your session is reserved. You will be directed to a payment page via Stripe or Venmo.  Once your payment is verified, your official confirmation is sent, and your secure Google Meet video link will arrive in your 24-hour reminder email." },
        { question: "How do I pay for my session?", answer: "Once you select your time, your session is reserved. You will be directed to a payment page via Stripe or Venmo (@NewTritious-Life). Once your payment is verified, your official confirmation is sent, and your secure Google Meet video link will arrive in your 24-hour reminder email." },
    ...
    bookSession: {
      back: "Back",
      brand: "NewTritious Life",
      scheduleOnline: "Schedule Online",
      title: "Book a Session",
      subtitle: "Choose a date and time that works for you. All sessions are 50 minutes.",
      choosePackage: "Choose a Package",
      packages: [
        { id: "kickstart", name: "Kickstart Consultation", price: "$175", description: "1 session — Required standalone session for all new clients." },
        { id: "habit_builder", name: "90-Day Habit Builder", price: "$525", badge: "Most Popular", description: "4 sessions total (Initial Consult + 3 follow-ups; payment plans available)." },
        { id: "vip_deep_dive", name: "VIP Deep Dive", price: "$950", badge: "Best Value", description: "7 sessions total (Initial Consult + 6 follow-ups, Fullscript lab orders, and custom support)." },
      ],
      ...
      emailPh: "your@email.com",
      telephone: "Telephone",
      telephonePh: "+1 (555) 000-0000",
      state: "State",
      statePh: "e.g. FL",
      paymentInfo: "Payment Information: Payment is completed externally via Zelle or Venmo. Upon booking, you will receive an email confirmation with payment instructions and your virtual meeting link.",
      requestBooking: "Request Booking →",
      selectFirst: "Please select a date and time first",
      processing: "Confirming your session…",
      allSet: "You're all set!",
      confirmationEmail: "A confirmation email with payment instructions is on its way to",
      checkInbox: "Check your inbox to finalize your booking.",
      intakeCta: "🌿 Next step: complete your health history intake form so I can prepare for our session.",
    ...
    freeCall: {
      ...
      subtitle: "All sessions are 15 minutes.",
      selectDate: "Select a Date",
      availableTimes: "Available Times",
      yourDetails: "Your Details",
      fullName: "Full Name",
      ...
      state: "State",
      statePh: "e.g. FL",
      confirmFreeCall: "Confirm Free Call →",
      selectFirst: "Please select a date and time first",
      processing: "Confirming your free call…",
      booked: "You're Booked! 🎉",
      callConfirmed: "Free 15-Minute Discovery Call Confirmed",
      dateTime: "Date & Time:",
      location: "Location:",
      googleMeet: "Google Meet (Video Call)",
      emailNote: "We will send a calendar invite and your secure video link to",
    ...
    bookingConfirmed: {
      back: "Back",
      brand: "NewTritious Life",
      noBooking: "No Pending Booking",
      noBookingDesc: "We couldn't find a pending session for your account. If you just booked, please try again in a moment.",
      bookSession: "Book a Session",
      title: "Booking Confirmed!",
      welcome: "Welcome, {name}! Your session is reserved. Complete the two steps below to finalize your booking.",
      ...
      phone: "Phone",
      state: "State",
      step1Title: "Complete Your Payment",
      step1Desc: "Send your session payment using one of the methods below:",
      venmo: "Venmo",
      zelle: "Zelle",
      paymentMemo: "Please include your full name in the payment memo so we can match it to your booking.",
      step2Title: "Fill Out Your Intake Form",
      step2Desc: "Complete your health history intake form so I can prepare for our time together. It only takes a few minutes.",
      startIntake: "Start Intake Form",
      whatsNext: "What Happens Next?",
      whatsNextDesc: "Once your payment is processed, your session is officially confirmed! You'll receive a reminder email 24 hours before our meeting with your secure Google Meet video link.",
      changeTime: "Need to change your time? Email",
      cancellationFee: "Cancellations or reschedules made less than 24 hours before your session are subject to a $75 fee.",
    },
    success: {
      back: "Back",
      brand: "NewTritious Life",
      ...
      errorDefault: "We couldn't confirm your booking.",
      returnHome: "Return Home",
      title: "Your Session is Confirmed",
      welcome: "Welcome, {name}! Your payment is complete and your session is reserved.",
      appointmentDetails: "Appointment Details",
      date: "Date",
      time: "Time",
      name: "Name",
      ...
      phone: "Phone",
      state: "State",
      intakeTitle: "Complete Your Intake Form",
      intakeDesc: "Complete your health history intake form so I can prepare for our time together. It only takes a few minutes.",
      startIntake: "Start Intake Form",
      completeIntake: "Complete Intake Form",
      whatsNext: "What Happens Next?",
      whatsNextDesc: "A confirmation email is on its way to you. You'll receive a reminder 24 hours before our meeting with your secure Google Meet video link.",
      home: "Home",
      changeTime: "Need to change your time? Email",
      cancellationFee: "Cancellations less than 24 hours before your session are subject to a $75 fee.",
    },
    intakeForm: {
      back: "Back",
      brand: "NewTritious Life",
      title: "Nutrition Intake Form",
      subtitle: "Fill out your health history so Yael can prepare for your session. It only takes a few minutes.",
      step: "Step",
      of: "of",
      step1Label: "Your Info",
      step2Label: "Health Goal",
      step3Label: "History",
      step4Label: "Diet & Lifestyle",
      step5Label: "Medical",
      fullName: "Full Name",
      fullNamePh: "Jane Doe",
      email: "Email",
      ...
      state: "State",
      statePh: "Florida",
      primaryGoal: "What is your main health or nutrition goal right now?",
      primaryGoalPh: "e.g., managing gut health, building balanced meal habits, sustainable energy…",
      pastApproaches: "What approaches, diets, or strategies have you tried in the past, and what did (or didn't) work for you?",
      pastApproachesPh: "Tell Yael about your past experiences…",
      dietary: "Do you have any specific food preferences, current daily meal routines, or food allergies I should keep in mind?",
      dietaryPh: "List any preferences, routines, or allergies…",
      medical: "Are there any medical conditions, past diagnoses, or medications/supplements you'd like me to know about?",
      medicalPh: "Share any medical details or write \"None\"…",
      next: "Next",
      backBtn: "Back",
      submit: "Submit Form",
      submitting: "Submitting…",
      successTitle: "You're All Set!",
      successMsg: "Your intake form has been submitted. Yael will review your answers and prepare for your session. We look forward to meeting you!",
  ...
  es: {
    ...
    faq: {
      ...
      items: [
        ...
        { question: "¿Qué pasa después de reservar?", answer: "Una vez que selecciones tu hora, tu sesión queda reservada. Serás dirigido a una página de pago vía Stripe o Venmo. Una vez verificado tu pago, se envía tu confirmación oficial, y tu enlace seguro de video de Google Meet llegará en tu correo de recordatorio de 24 horas." },
        { question: "¿Cómo pago mi sesión?", answer: "Una vez que selecciones tu hora, tu sesión queda reservada. Serás dirigido a una página de pago vía Stripe o Venmo (@NewTritious-Life). Una vez verificado tu pago, se envía tu confirmación oficial, y tu enlace seguro de video de Google Meet llegará en tu correo de recordatorio de 24 horas." },
    ...
    bookSession: {
      back: "Atrás",
      brand: "NewTritious Life",
      scheduleOnline: "Reservar en Línea",
      title: "Reservar una Cita",
      subtitle: "Elige una fecha y hora que funcione para ti. Todas las sesiones son de 50 minutos.",
      choosePackage: "Elige un Paquete",
      packages: [
        { id: "kickstart", name: "Consulta Inicial", price: "$175", description: "1 sesión — Sesión independiente requerida para todos los clientes nuevos." },
        { id: "habit_builder", name: "Constructor de Hábitos 90 Días", price: "$525", badge: "Más Popular", description: "4 sesiones en total (Consulta Inicial + 3 seguimientos; planes de pago disponibles)." },
        { id: "vip_deep_dive", name: "VIP Análisis Profundo", price: "$950", badge: "Mejor Valor", description: "7 sesiones en total (Consulta Inicial + 6 seguimientos, análisis de Fullscript y apoyo personalizado)." },
      ],
      ...
      state: "Estado",
      statePh: "ej. FL",
      paymentInfo: "Información de Pago: El pago se completa externamente vía Zelle o Venmo. Al reservar, recibirás un correo de confirmación con instrucciones de pago y tu enlace de reunión virtual.",
      requestBooking: "Solicitar Reserva →",
      selectFirst: "Por favor selecciona una fecha y hora primero",
      processing: "Confirmando tu sesión…",
      allSet: "¡Todo listo!",
      confirmationEmail: "Un correo de confirmación con instrucciones de pago va en camino a",
      checkInbox: "Revisa tu bandeja de entrada para finalizar tu reserva.",
      intakeCta: "🌿 Próximo paso: completa tu formulario de historial de salud para que pueda prepararme para nuestra sesión.",
      startIntake: "Comenzar Formulario de Admisión",
    ...
    freeCall: {
      ...
      subtitle: "Todas las sesiones son de 15 minutos.",
      selectDate: "Selecciona una Fecha",
      availableTimes: "Horas Disponibles",
      yourDetails: "Tus Datos",
      fullName: "Nombre Completo",
      ...
      state: "Estado",
      statePh: "ej. FL",
      confirmFreeCall: "Confirmar Llamada Gratis →",
      selectFirst: "Por favor selecciona una fecha y hora primero",
      processing: "Confirmando tu llamada gratis…",
      booked: "¡Reservaste! 🎉",
      callConfirmed: "Llamada de Descubrimiento de 15 Minutos Confirmada",
      dateTime: "Fecha y Hora:",
      location: "Ubicación:",
      googleMeet: "Google Meet (Videollamada)",
      emailNote: "Enviaremos una invitación de calendario y tu enlace seguro de video a",
      lookingForward: "¡Espero hablar contigo!",
      returnHome: "Volver al Inicio",
      bookAnother: "Reservar Otra",
    },
    bookingConfirmed: {
      back: "Atrás",
      brand: "NewTritious Life",
      noBooking: "Sin Reserva Pendiente",
      noBookingDesc: "No pudimos encontrar una sesión pendiente para tu cuenta. Si acabas de reservar, por favor inténtalo de nuevo en un momento.",
      bookSession: "Reservar una Cita",
      title: "¡Reserva Confirmada!",
      welcome: "¡Bienvenido/a, {name}! Tu sesión está reservada. Completa los dos pasos a continuación para finalizar tu reserva.",
      ...
      phone: "Teléfono",
      state: "Estado",
      step1Title: "Completa Tu Pago",
      step1Desc: "Envía el pago de tu sesión usando uno de los métodos a continuación:",
      venmo: "Venmo",
      zelle: "Zelle",
      paymentMemo: "Por favor incluye tu nombre completo en la nota de pago para que podamos asociarlo a tu reserva.",
      step2Title: "Completa Tu Formulario de Admisión",
      step2Desc: "Completa tu formulario de historial de salud para que pueda prepararme para nuestro tiempo juntos. Solo toma unos minutos.",
      startIntake: "Comenzar Formulario de Admisión",
      whatsNext: "¿Qué Pasa Después?",
      whatsNextDesc: "Una vez que tu pago sea procesado, ¡tu sesión estará oficialmente confirmada! Recibirás un correo de recordatorio 24 horas antes de nuestra reunión con tu enlace seguro de video de Google Meet.",
      changeTime: "¿Necesitas cambiar tu hora? Envía un correo a",
      cancellationFee: "Las cancelaciones o reprogramaciones hechas con menos de 24 horas antes de tu sesión están sujetas a una tarifa de $75.",
    },
    success: {
      back: "Atrás",
      brand: "NewTritious Life",
      ...
      errorDefault: "No pudimos confirmar tu reserva.",
      returnHome: "Volver al Inicio",
      title: "Tu Sesión Está Confirmada",
      welcome: "¡Bienvenido/a, {name}! Tu pago está completo y tu sesión está reservada.",
      appointmentDetails: "Detalles de la Cita",
      date: "Fecha",
      time: "Hora",
      name: "Nombre",
      ...
      phone: "Teléfono",
      state: "Estado",
      intakeTitle: "Completa Tu Formulario de Admisión",
      intakeDesc: "Completa tu formulario de historial de salud para que pueda prepararme para nuestro tiempo juntos. Solo toma unos minutos.",
      startIntake: "Comenzar Formulario de Admisión",
      completeIntake: "Completar Formulario de Admisión",
      whatsNext: "¿Qué Pasa Después?",
      whatsNextDesc: "Un correo de confirmación va en camino hacia ti. Recibirás un recordatorio 24 horas antes de nuestra reunión con tu enlace seguro de video de Google Meet.",
      home: "Inicio",
      changeTime: "¿Necesitas cambiar tu hora? Envía un correo a",
      cancellationFee: "Las cancelaciones hechas con menos de 24 horas antes de tu sesión están sujetas a una tarifa de $75.",
    },
    intakeForm: {
      back: "Atrás",
      brand: "NewTritious Life",
      title: "Formulario de Admisión de Nutrición",
      subtitle: "Completa tu historial de salud para que Yael pueda prepararse para tu sesión. Solo toma unos minutos.",
      step: "Paso",
      of: "de",
      step1Label: "Tus Datos",
      step2Label: "Meta de Salud",
      step3Label: "Historial",
      step4Label: "Dieta y Estilo de Vida",
      step5Label: "Médico",
      fullName: "Nombre Completo",
      fullNamePh: "Juana Pérez",
      email: "Correo",
      emailPh: "juana@example.com",
      phone: "Teléfono (opcional)",
      phonePh: "(555) 123-4567",
      state: "Estado",
      statePh: "Florida",
      primaryGoal: "¿Cuál es tu principal meta de salud o nutrición en este momento?",
      primaryGoalPh: "ej., salud intestinal, hábitos alimenticios equilibrados, energía sostenible…",
      pastApproaches: "¿Qué enfoques, dietas o estrategias has probado en el pasado, y qué funcionó (o no) para ti?",
      pastApproachesPh: "Cuéntale a Yael sobre tus experiencias anteriores…",
      dietary: "¿Tienes alguna preferencia alimentaria, rutina diaria de comidas, o alergias que deba tener en cuenta?",
      dietaryPh: "Lista cualquier preferencia, rutina o alergia…",
      medical: "¿Hay alguna condición médica, diagnóstico previo, o medicamentos/suplementos que quieras que sepa?",
      medicalPh: "Comparte cualquier detalle médico o escribe \"Ninguno\"…",
      next: "Siguiente",
      backBtn: "Atrás",
      submit: "Enviar Formulario",
      submitting: "Enviando…",
      successTitle: "¡Todo Listo!",
      successMsg: "Tu formulario de admisión ha sido enviado. Yael revisará tus respuestas y se preparará para tu sesión. ¡Esperamos verte pronto!",
      returnHome: "Volver al Inicio",
      required: "Requerido",
    },
  },
